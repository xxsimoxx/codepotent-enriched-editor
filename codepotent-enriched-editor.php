...
class Enriched_Editor {
	...
	public function __construct() {
		...
		add_action('admin_enqueue_scripts', [$this, 'cm_scripts'], 999);
	...
	public function cm_after_tiny() {
		...
		console.log('afterTiny');
		var codeMirrorObj;
		function showCodeMirror()
		{
			codeMirrorObj = wp.CodeMirror.fromTextArea( jQuery( '#content' ), {
				mode: 'text/html',
				tabMode: 'indent',
				lineNumbers: true,
				lineWrapping: true
	...
	public function load_textdomain() {
	    load_plugin_textdomain( 'codepotent-enriched-editor', false, 'codepotent-enriched-editor/language' );
	}
	...
	public function settings_page() {
		...
		$this->set_paths();
		include_once( WYSIWYG_PATH . 'codepotent-enriched-editor-admin.php' );
	}
	...
	public function add_settings_link( $links, $file ) {
		if ( $file === 'codepotent-enriched-editor/codepotent-enriched-editor.php' && current_user_can( 'manage_options' ) ) {
			$settings_link = sprintf( '<a href="%s">%s</a>', admin_url( 'options-general.php?page=codepotent-enriched-editor' ), __( 'Settings', 'codepotent-enriched-editor' ) );
